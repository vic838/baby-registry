...
export default function AdminDashboardPage() {
  ...
  const [typeFilter, setTypeFilter] = useState<"all" | "checkout" | "contribution">("all");
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-neutral-600">
              Checkouts en contributions beheren, betalingen bevestigen en corrigeren.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
          <div className="rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm">
            ...
            <div className="mt-2 text-sm text-neutral-700">
              Paid: {stats?.checkout_paid_count ?? 0} · Open: {stats?.checkout_open_count ?? 0}
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm">
            ...
            <div className="mt-2 text-sm text-neutral-700">
              Paid: {stats?.contribution_paid_count ?? 0} · Open: {stats?.contribution_open_count ?? 0}
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3 rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm sm:flex-row">
          <div>
            ...
            <select
              value={typeFilter}
              onChange={(e) =>
                setTypeFilter(e.target.value as "all" | "checkout" | "contribution")
              }
                ...
                >
                  <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    <div className="space-y-2">
                      <div className="flex flex-wrap items-center gap-2">
                        <span className="rounded-full bg-neutral-100 px-2.5 py-1 text-xs font-medium text-neutral-700">
                          {row.kind === "checkout" ? "Checkout" : "Contribution"}
                        </span>
                    ...
                    <div className="flex flex-col gap-2 sm:min-w-[180px]">
                      ...
                      <button
                        type="button"
                        onClick={() => updateStatus(row.kind, row.id, "REPORTED")}
